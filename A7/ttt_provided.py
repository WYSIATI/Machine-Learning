...
class TTTBoard:
    ...
    def check_win(self):
        ...
        #     l1 = line[:3]
        #     l2 = line[1:4]
        #     if len(set(l1)) == 1 and l1[0] != EMPTY:
        #         if self._reverse:
        #             return switch_player(l1[0])
        #         else:
        #             return l1[0]
        #     if len(set(l2)) == 1 and l2[0] != EMPTY:
        #         if self._reverse:
        #             return switch_player(l2[0])
        #         else:
        #             return l2[0]
...
def play_game(mc_move_function, ntrials, reverse = False):
    ...
    while winner == None:
        if curplayer == PLAYERO:
            ...
            # # Prompt user to input next move, for human player
            # input_var = input("Enter your move: ")
            # row = input_var[0]
            # col = input_var[1]

            # Random player
            empty_squares = board.get_empty_squares()
            empty_square = empty_squares[random.randrange(len(empty_squares))]
            row = empty_square[0]
            col = empty_square[1]
